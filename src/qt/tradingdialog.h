...
private slots:
    ...
    QString BuyNIHL(QString OrderType, double Quantity, double Rate);
    QString SellNIHL(QString OrderType, double Quantity, double Rate);
