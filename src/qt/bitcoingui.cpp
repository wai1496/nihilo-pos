...
{
    resize(900, 520);
    setWindowTitle(tr("Nihilo") + " - " + tr("Wallet"));
...
#endif
    setObjectName("nihilo");
    setStyleSheet("#nihilo { background-color: #ffffff;  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Nihilo address"));
    ...
    pioAction = new QAction(tr("&Nihilo Website"), this);
	pioAction->setToolTip(tr("Visit the Official Nihilo website"));
    bitcointalkAction = new QAction(tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk Nihilo discussion thread"));
    chainAction = new QAction(tr("&Nihilo Discord"), this);
    chainAction->setToolTip(tr("Join Nihilo Discord"));
    explorerAction = new QAction(tr("&Nihilo Explorer"), this);
	explorerAction->setToolTip(tr("Nihilo Explorer"));	
    aboutAction = new QAction(tr("&About Nihilo"), this);
    aboutAction->setToolTip(tr("Show information about Nihilo"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Nihilo"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 13px; font-weight: 600; font-family: 'Verdana'; padding: 5px; padding-left: 8px; border: none; margin: 5px; border-radius: 4px; }"
                           "QToolButton:hover { background-color: #00CCA3; border: none; padding-top: 5px; padding-bottom: 5px; }"
                           "QToolButton:checked { background-color: #00CCA3; border: none; padding-top: 5px; padding-bottom: 5px; }"
                           "QToolButton:pressed { background-color: #00e6b8; border: none; padding-top: 5px; padding-bottom: 5px; }"
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Nihilo client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Nihilo client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nihilo network", "", count));
}
...
void BitcoinGUI::gotomktPage()
{
    ...
    QDesktopServices::openUrl(QUrl("https://nihilo.space/redirect/marketplace"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Nihilo address or malformed URI parameters."));
    }
...
{
    QDesktopServices::openUrl(QUrl("https://nihilo.space"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("https://nihilo.space/redirect/bitcointalk"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("https://nihilo.space/redirect/discord"));
}
void BitcoinGUI::explorerClicked()
{
    QDesktopServices::openUrl(QUrl("https://nihilo.space/redirect/explorer"));
}
