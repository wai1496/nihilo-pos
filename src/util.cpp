...
int nAnonymizenihiloAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Nihilo
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Nihilo
    // Mac: ~/Library/Application Support/Nihilo
    // Unix: ~/.nihilo
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Nihilo";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "nihilo.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "nihilod.pid"));
